	...
	<script type="text/javascript" src="jquery-easyui-1.5.3/jquery.easyui.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            if (dd !== null) {
                ...
                rowe[2].value = dd["Chinesename"] +"&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href=\"#\" onclick=\"return chooseChinese();\">*更改中文名称*</a>" + "<a href=\"#\" style=\"display:block;float:right\" onclick=\"return newChinese();\">*新建中文名称*</a>";
                rowe[3].value = dd["Englishname"] +"&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href=\"#\" onclick=\"return chooseEnglish();\">*更改英文名称*</a>" + "<a href=\"#\" style=\"display:block;float:right\" onclick=\"return newEnglish();\">*新建英文名称*</a>";
                rowe[4].value = dd["devicename"] +"&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href=\"#\" onclick=\"return chooseDesign();\">*更改名称代号*</a>" + "<a href=\"#\" style=\"display:block;float:right\" onclick=\"return newDesign();\">*新建名称代号*</a>";
                rowe[5].value = dd["subsystem"] +"&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href=\"#\" style=\"display:block;float:right\" onclick=\"return chooseSubsystem();\">*更改主体分区*</a>";
                rowe[6].value = dd["location"] + "&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href=\"#\" style=\"display:block;float:right\" onclick=\"return chooseLocation();\">*更改位置信息*</a>";
                rowe[7].value = dd["judge"] +"&nbsp;&nbsp;&nbsp;&nbsp;" + "<a href=\"#\" style=\"display:block;float:right\" onclick=\"return chooseJudge();\">*更改选择Yes/No*</a>"
                rowe[8].value = dd["another"];
                rowe[9].value = dd["remark"];
            }
